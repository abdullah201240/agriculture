          ...
          <div className="container px-4 mx-auto ">
            <div className="-mx-4 flex flex-wrap justify-between">
              ...
              <div className="px-3 my-4 w-full xl:w-1/4">
                ...
                An innovative IoT and AI-powered system designed to optimize crop selection through soil data analysis and classify crop diseases using advanced deep learning techniques, ensuring smarter, healthier, and more sustainable farming practices.
                </p>
                <br />
                <div>
                  <Link href="" className="inline-flex items-center justify-center h-8 w-8 border border-white rounded-full mr-3 hover:text-[#20a320] hover:border-[#20a320]"
                    aria-label="Facebook"
                  >
              ...
              <div className="px-3 my-4 w-full sm:w-auto text-white">
                ...
                <ul className="leading-8 pt-3">
                  <li>
                    <FaMapMarkerAlt style={{ color: '#20a320' }} className="inline-block mr-2 text-white" />
                    Office address: Dhaka
                  </li>
                  <li className=' pt-2'>
                    <FaEnvelope style={{ color: '#20a320' }} className="inline-block mr-2 text-white" />
                    Email: arisense@gmail.com
                  </li>
                  <li className=' pt-2'>
                    <FaPhoneAlt style={{ color: '#20a320' }} className="inline-block mr-2 text-white" />
                    Phone: (+880) 180-0000000
                  </li>
                  <li className=' pt-2'>
                    <FaPhoneAlt style={{ color: '#20a320' }} className="inline-block mr-2 text-white" />
                    Phone: (+880) 160-0000000
                  </li>
                </ul>
              </div>
              ...
              <div className="px-3 my-4 w-full sm:w-auto">
                ...
                <ul className="leading-8 pt-3">
                  <li><Link href="/" className="hover:text-[#20a320]">Home</Link></li>
                  <li><Link href="/aboutUs" className="hover:text-[#20a320]">About Us</Link></li>
                  
                  
                  <li><Link href="/contactUs" className="hover:text-[#20a320]">Contract Us</Link></li>
                </ul>
              </div>
              <div className=" my-4 w-full sm:w-auto text-white">
          ...
          <div className="container mx-auto text-center max-w-[1330] py-4 text-white border-t border-white">
            <div className="flex justify-center items-center">
              <div className="text-center">
                © Copyright {new Date().getFullYear()} AgroMind Insights AI All rights reserved. | Development by AgroMind Insights AI
              </div>
            </div>
          </div>
        </div>
